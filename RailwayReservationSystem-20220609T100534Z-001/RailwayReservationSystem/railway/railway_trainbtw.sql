...
--
-- Table structure for table `trainbtw`
--

DROP TABLE IF EXISTS `trainbtw`;
...
--
-- Dumping data for table `trainbtw`
--

LOCK TABLES `trainbtw` WRITE;
/*!40000 ALTER TABLE `trainbtw` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `trainbtw` ENABLE KEYS */;
UNLOCK TABLES;
